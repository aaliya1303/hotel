	...
	<div style = "margin: auto;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<strong><h3 style="text-align: center;">ABOUT US</h3></strong>
				<p style = "position:relative; text-align: center; width:100%; font-size: 20px;">Hotel unveils a celebrated balance of nostalgia and contemporary style, capturing its original Southern elegance, luxury, and decadence. Machuca tiles form cool geometric patterns in the hallways. Hotel hardwood floors contrast modern furnishings and amenities in the dramatic suites.
				...
				<div class="note" style="width: 50%; float: left; font-size: 16px;margin-top: 10px;">
					<ul>
				...
				<div class="image" style="width: 40%; float: left; margin: 10px;">
					<img style = "float:right;" src = "images/about.jpg" width = "300px" height = "500px" />
				</div>
